        ...
        : SizedBox(
          ...
          child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor:
                    widget.negativeColor ? kWhiteColor : kSecondaryColor,
                          ...
                          Expanded(
                            child: Center(
                              child: Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                softWrap: true,
                              style:    TextStyle(fontWeight: FontWeight.w700, fontSize: 15, color:   widget.negativeColor ? kSecondaryColor: kWhiteColor)
                              ),
                            ),
                          ),
